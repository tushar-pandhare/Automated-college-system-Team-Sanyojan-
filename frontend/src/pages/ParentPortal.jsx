...
const ParentPortal = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const serviceId = "service_g4plcqf";  // Replace with your actual service ID
        const templateId = "template_awocd29"; // Replace with your actual template ID
        const publicKey = "lccFlKdzz77DhynF5"; // Replace with your actual public key

        // Dynamic template parameters
        const templateParams = {
          from_name: name,
          from_email: email,  // Sender's email
          to_email: email,  // This now matches the EmailJS template variable
          message: message,
      };
